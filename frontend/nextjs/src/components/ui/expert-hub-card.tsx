...
const ExpertHubCard = ({ data }: { data: ExpertTicket }) => {
    ...
    return (
        <Card className='border border-stroke/[.1] p-4 bg-glass/[0.4] backdrop-blur-md min-w-[244px]'>
            ...
            <CardFooter className='pb-0 px-0 flex justify-between'>
                <div className="flex justify-between w-full items-center">
                    ...
                    <div className="text-lg font-semibold text-accent-3">{paymentCurrency}{price}</div>
                </div>
            </CardFooter>
        </Card>
    )
