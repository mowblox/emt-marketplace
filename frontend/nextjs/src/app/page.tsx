...
import { CREATE_A_POST_PAGE, HOME_PAGE, ONBOARDING_PAGE } from "./(with wallet)/_components/page-links"
  ...
  return (
    <>
      ...
      <div className=" h-screen w-full container">
        ...
        <section className="flex flex-col justify-center items-center text-center my-20 mb-22 gap-4 "
        >
          <div className="flex flex-col gap-6 justify-start md:justify-center items-center max-w-[577px] mb-8">
        ...
        <section className="flex flex-col justify-center items-center text-center pb-30 pt-10"
        >
