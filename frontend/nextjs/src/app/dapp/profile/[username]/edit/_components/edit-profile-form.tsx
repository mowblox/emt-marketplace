...
const EditProfileForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const updates = getChanges(user!, values);
    !areArraysEqual(user?.tags, selectedTags) && (updates.tags = selectedTags);
    ...
    try {
      ...
      router.push("/dapp/profile/" + username);
    } catch (err) {
      console.log("err", err);
      toast({
