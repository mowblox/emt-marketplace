      ...
      ItemComponent={({ data }: { data: Booking }) => {
        ...
        return (
          <>
            <Dialog>
              <DialogTrigger>
                <ExpertHubCard data={data.exptListing!} type="modal" />
              </DialogTrigger>
                ...
                <div className="grid grid-cols-1 md:grid-cols-[35%_60%]">
                  <ScrollArea className="hidden md:block h-[90vh]">
                    <div className="border-r pr-6 py-6">
                      ...
                      <ExpertHubCard data={exptListing} disableLink={true} />
                      <div className="my-5">
                        <div className="text-sm mb-2">Session Duration</div>
                        <div className="text-xs text-muted">
                          {data.sessionCount} session(s) x{" "}
                          {exptListing.sessionDuration} minutes
                        </div>
                      </div>
